...
//        if(mHolder.mOffsetY!=0)return;
        ALog.d("onLayout mHolder.mOffsetY=" + mHolder.mOffsetY);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                ALog.d("isTop=" + mContentView.isTop() + ";isBottom=" + mContentView.isBottom());
    ...
    private void resetHeaderHeight() {
        ...
        ALog.d("resetHeaderHeight offsetY=" + offsetY);
    }
...
//            headerMovePercent = headerMovePercent > 1 ? 1 : headerMovePercent;
    ...
    public void stopRefresh(boolean success) {
        ALog.d("stopRefresh mPullRefreshing=" + mPullRefreshing);
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            if (mScroller.computeScrollOffset()) {
                ...
                ALog.d("currentY=" + currentY + ";mHolder.mOffsetY=" + mHolder.mOffsetY);
