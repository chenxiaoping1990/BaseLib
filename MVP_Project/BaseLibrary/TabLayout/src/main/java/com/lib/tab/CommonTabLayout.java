...
import com.lib.tab.listener.CustomTabEntity;
import com.lib.tab.listener.OnTabSelectListener;
import com.lib.tab.utils.FragmentChangeManager;
import com.lib.tab.utils.UnreadMsgUtils;
import com.lib.tab.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void notifyDataSetChanged() {
        ...
        this.mTabCount = getSize(mTabEntitys);
        View tabView;
