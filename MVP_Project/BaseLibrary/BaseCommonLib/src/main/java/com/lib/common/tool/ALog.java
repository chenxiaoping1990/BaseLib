...
public final class ALog {
    ...
    public static void file(Context context,Object contents) {
        file(context,"",contents);
    }

    public static void file(Context context, String tag, Object contents) {
        print2File(context, tag, contents.toString());
    }
    ...
    private static void print2File(Context context, final String tag, final String msg) {
        String dir;// log存储目录
